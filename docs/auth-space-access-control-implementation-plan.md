...
- [1. Purpose](#1-purpose)
  - [1.1 Aggressive Revision: Do Not Preserve Client-Centric Data As Target State](#11-aggressive-revision-do-not-preserve-client-centric-data-as-target-state)
- [2. Current State](#2-current-state)
  - [2.1 Relevant Auther Files](#21-relevant-auther-files)
  - [2.2 Current Page Composition](#22-current-page-composition)
  - [2.3 Current Canonical Backing Client Rule](#23-current-canonical-backing-client-rule)
  - [2.4 Current Schema Shape](#24-current-schema-shape)
  - [2.5 Current Correct Pieces To Preserve](#25-current-correct-pieces-to-preserve)
- [3. Target Product Shape](#3-target-product-shape)
  - [3.1 The Authorization Space Page Owns Resource Authorization](#31-the-authorization-space-page-owns-resource-authorization)
  - [3.2 What Happens To The Four Existing Tabs](#32-what-happens-to-the-four-existing-tabs)
  - [3.3 Proposed Final Tabs](#33-proposed-final-tabs)
  - [3.4 What Moves Out](#34-what-moves-out)
- [4. Main Technical Problem](#4-main-technical-problem)
- [5. Implementation Strategy](#5-implementation-strategy)
  - [5.1 Add A Space-Native Service Layer First](#51-add-a-space-native-service-layer-first)
  - [5.2 Expand Space Actions](#52-expand-space-actions)
  - [5.3 Stop Importing Client Access Actions From The Space Page](#53-stop-importing-client-access-actions-from-the-space-page)
  - [5.4 Split Or Replace The Old `AccessControl` Component](#54-split-or-replace-the-old-accesscontrol-component)
  - [5.5 Keep The Backing Client Only As A Server-Side Bridge](#55-keep-the-backing-client-only-as-a-server-side-bridge)
- [6. Detailed Tab Plans](#6-detailed-tab-plans)
- [6.1 `Models` Tab](#61-models-tab)
  - [6.1.1 Current Problems](#611-current-problems)
  - [6.1.2 Target Behavior](#612-target-behavior)
  - [6.1.3 Implementation Tasks](#613-implementation-tasks)
  - [6.1.4 Save Flow](#614-save-flow)
  - [6.1.5 Rename Flow](#615-rename-flow)
  - [6.1.6 Delete Flow](#616-delete-flow)
  - [6.1.7 Edge Cases](#617-edge-cases)
  - [6.1.8 Tests](#618-tests)
- [6.2 `Resource Grants` Tab](#62-resource-grants-tab)
  - [6.2.1 Current Problems](#621-current-problems)
  - [6.2.2 Target Behavior](#622-target-behavior)
  - [6.2.3 Implementation Tasks](#623-implementation-tasks)
  - [6.2.4 Remove The Duplicate Top-Level Space Grants Section](#624-remove-the-duplicate-top-level-space-grants-section)
  - [6.2.5 API Key Subjects](#625-api-key-subjects)
  - [6.2.6 Full Access Display](#626-full-access-display)
  - [6.2.7 Pagination And Filters](#627-pagination-and-filters)
  - [6.2.8 Edge Cases](#628-edge-cases)
  - [6.2.9 Tests](#629-tests)
- [6.3 `Service Accounts` / `API Keys` Tab](#63-service-accounts-api-keys-tab)
  - [6.3.1 Current Problems](#631-current-problems)
  - [6.3.2 Target Behavior](#632-target-behavior)
  - [6.3.3 API Key Enablement](#633-api-key-enablement)
  - [6.3.4 Listing Keys](#634-listing-keys)
  - [6.3.5 Creating Keys](#635-creating-keys)
  - [6.3.6 Revoking Keys](#636-revoking-keys)
  - [6.3.7 Edge Cases](#637-edge-cases)
  - [6.3.8 Tests](#638-tests)
- [6.4 `Linked Clients` Tab](#64-linked-clients-tab)
  - [6.4.1 Purpose](#641-purpose)
  - [6.4.2 Target Fields](#642-target-fields)
  - [6.4.3 Link Mode Semantics](#643-link-mode-semantics)
  - [6.4.4 What To Do With Platform Access](#644-what-to-do-with-platform-access)
  - [6.4.5 Edge Cases](#645-edge-cases)
  - [6.4.6 Tests](#646-tests)
- [7. Permission Model For Managing The Space](#7-permission-model-for-managing-the-space)
  - [7.1 Current State](#71-current-state)
  - [7.2 Target Rule For This Iteration](#72-target-rule-for-this-iteration)
  - [7.3 Future Space Delegation](#73-future-space-delegation)
  - [7.4 Edge Cases](#74-edge-cases)
- [8. Migration And Backfill](#8-migration-and-backfill)
  - [8.1 Required Data Audit](#81-required-data-audit)
  - [8.2 Backfill Rules](#82-backfill-rules)
  - [8.3 Rollback](#83-rollback)
- [9. Implementation Backlog](#9-implementation-backlog)
- [R5-0. Normalize Model Identity Away From Clients](#r5-0-normalize-model-identity-away-from-clients)
  - [R5-0A Add Model Alias Schema](#r5-0a-add-model-alias-schema)
  - [R5-0B Freeze Client-Prefixed Model Writes](#r5-0b-freeze-client-prefixed-model-writes)
  - [R5-0C Backfill Canonical Models And Consumers](#r5-0c-backfill-canonical-models-and-consumers)
- [R5-A. Stabilize Space-Native Reads](#r5-a-stabilize-space-native-reads)
  - [R5-A1 Add Space Access Service](#r5-a1-add-space-access-service)
  - [R5-A2 Replace Page Data Loading](#r5-a2-replace-page-data-loading)
- [R5-B. Correct Models Tab](#r5-b-correct-models-tab)
  - [R5-B1 Build Space Models Components](#r5-b1-build-space-models-components)
  - [R5-B2 Add Space Model Actions](#r5-b2-add-space-model-actions)
- [R5-C. Correct Resource Grants Tab](#r5-c-correct-resource-grants-tab)
  - [R5-C1 Merge Space Grants And Scoped Permissions](#r5-c1-merge-space-grants-and-scoped-permissions)
  - [R5-C2 Add Space Grant Actions](#r5-c2-add-space-grant-actions)
- [R5-D. Correct Service Accounts/API Keys Tab](#r5-d-correct-service-accountsapi-keys-tab)
  - [R5-D1 Add Space API-Key Metadata](#r5-d1-add-space-api-key-metadata)
  - [R5-D2 Add Strict Space API-Key Actions](#r5-d2-add-strict-space-api-key-actions)
  - [R5-D3 Build Service Accounts UI](#r5-d3-build-service-accounts-ui)
- [R5-E. Move Platform Access Out](#r5-e-move-platform-access-out)
  - [R5-E1 Move Platform Access To Global Control Plane](#r5-e1-move-platform-access-to-global-control-plane)
  - [R5-E2 Update Client Access Redirect](#r5-e2-update-client-access-redirect)
- [R5-F. Linked Clients Tab](#r5-f-linked-clients-tab)
  - [R5-F1 Build Linked Clients Summary](#r5-f1-build-linked-clients-summary)
- [R5-G. Tests And Verification](#r5-g-tests-and-verification)
  - [R5-G1 Unit Tests](#r5-g1-unit-tests)
  - [R5-G2 Typecheck/Lint](#r5-g2-typechecklint)
  - [R5-G3 Manual Verification](#r5-g3-manual-verification)
- [10. Things That Are Easy To Miss](#10-things-that-are-easy-to-miss)
  - [10.1 Client Link Mode Is Not Resource Access](#101-client-link-mode-is-not-resource-access)
  - [10.2 `authorization_space full_access` Is Resource Access, Not Management Access](#102-authorizationspace-fullaccess-is-resource-access-not-management-access)
  - [10.3 Backing Client Must Not Leak Into Resource Decisions](#103-backing-client-must-not-leak-into-resource-decisions)
  - [10.4 Legacy Untagged API Keys Are Dangerous](#104-legacy-untagged-api-keys-are-dangerous)
  - [10.5 Prefix-Based Cascades Can Delete Too Much](#105-prefix-based-cascades-can-delete-too-much)
  - [10.6 Model Display Names Can Collide](#106-model-display-names-can-collide)
  - [10.7 Deleting Relations Is More Dangerous Than Deleting Permissions](#107-deleting-relations-is-more-dangerous-than-deleting-permissions)
  - [10.8 Model Rename Must Update Denormalized Tuple Strings](#108-model-rename-must-update-denormalized-tuple-strings)
  - [10.9 Resource Token Flow Depends On Links](#109-resource-token-flow-depends-on-links)
  - [10.10 Payload Projection Still Uses Existing Entity Types](#1010-payload-projection-still-uses-existing-entity-types)
