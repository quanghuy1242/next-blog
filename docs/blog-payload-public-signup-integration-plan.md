...
- [3. Current-State Findings](#3-current-state-findings)
  - [3.1 `next-blog`](#31-next-blog)
  - [3.2 `payloadcms`](#32-payloadcms)
  - [3.3 Auther Signup Intent Endpoint](#33-auther-signup-intent-endpoint)
- [4. Architecture Decisions](#4-architecture-decisions)
  - [4.1 Blog Owns Signup Initiation](#41-blog-owns-signup-initiation)
  - [4.2 Signup Should Return Through Blog Login](#42-signup-should-return-through-blog-login)
  - [4.3 Public Commenter Is Not Payload Staff](#43-public-commenter-is-not-payload-staff)
  - [4.4 Comment Authorization Must Match The Grant Model](#44-comment-authorization-must-match-the-grant-model)
- [5. Target High-Level Architecture](#5-target-high-level-architecture)
- [6. `next-blog` Implementation Plan](#6-next-blog-implementation-plan)
  - [6.1 Environment Contract](#61-environment-contract)
  - [6.2 New Server Route: `/auth/signup`](#62-new-server-route-authsignup)
  - [6.3 Header UI](#63-header-ui)
  - [6.4 Comment CTA UI](#64-comment-cta-ui)
  - [6.5 Gated Content CTA](#65-gated-content-cta)
  - [6.6 Sign-In Page Fallback](#66-sign-in-page-fallback)
- [7. PayloadCMS Access Model Plan](#7-payloadcms-access-model-plan)
  - [7.1 Problem](#71-problem)
  - [7.2 Target Role Model](#72-target-role-model)
  - [7.3 Staff Helper Functions](#73-staff-helper-functions)
  - [7.4 Payload Admin Shell Access](#74-payload-admin-shell-access)
  - [7.5 Collection Access Matrix](#75-collection-access-matrix)
  - [7.6 Content Collection Changes](#76-content-collection-changes)
  - [7.7 Public Feature Collections](#77-public-feature-collections)
  - [7.8 Comment Access Policy](#78-comment-access-policy)
  - [7.9 Better Auth Role Mapping](#79-better-auth-role-mapping)
- [8. Auther Admin Setup After Prerequisite Epic](#8-auther-admin-setup-after-prerequisite-epic)
  - [8.1 Authorization Space](#81-authorization-space)
  - [8.2 Linked Client](#82-linked-client)
  - [8.3 Onboarding Flow](#83-onboarding-flow)
  - [8.4 Payload Webhook](#84-payload-webhook)
  - [8.5 Payload Environment](#85-payload-environment)
- [9. User Experience Requirements](#9-user-experience-requirements)
  - [9.1 Header](#91-header)
  - [9.2 Comment Section](#92-comment-section)
  - [9.3 Signup Error States](#93-signup-error-states)
  - [9.4 After Email Verification](#94-after-email-verification)
- [10. Edge Cases And Failure Modes](#10-edge-cases-and-failure-modes)
  - [10.1 Signup Intent Minted But Policy Changes Before Verification](#101-signup-intent-minted-but-policy-changes-before-verification)
  - [10.2 User Already Has Auther Account](#102-user-already-has-auther-account)
  - [10.3 User Already Has Payload User But No Mirror Row](#103-user-already-has-payload-user-but-no-mirror-row)
  - [10.4 User Has Commenter But Opens Payload Admin](#104-user-has-commenter-but-opens-payload-admin)
  - [10.5 User Has Admin Or Editor](#105-user-has-admin-or-editor)
  - [10.6 Post Comments](#106-post-comments)
- [11. Implementation Backlog](#11-implementation-backlog)
  - [11.1 `next-blog`: Signup Intent Client](#111-next-blog-signup-intent-client)
  - [11.2 `next-blog`: Signup UI Entrypoints](#112-next-blog-signup-ui-entrypoints)
  - [11.3 `next-blog`: Auth Entry Fallback](#113-next-blog-auth-entry-fallback)
  - [11.4 `payloadcms`: Role Model Hardening](#114-payloadcms-role-model-hardening)
  - [11.5 `payloadcms`: Content Access Hardening](#115-payloadcms-content-access-hardening)
  - [11.6 `payloadcms`: Payload Admin Shell Gate](#116-payloadcms-payload-admin-shell-gate)
  - [11.7 `payloadcms`: Commenter Grant Enforcement](#117-payloadcms-commenter-grant-enforcement)
  - [11.8 `payloadcms`: Mirror Support For Any New Comment Targets](#118-payloadcms-mirror-support-for-any-new-comment-targets)
  - [11.9 Deployment Configuration](#119-deployment-configuration)
  - [11.10 Manual Smoke](#1110-manual-smoke)
- [12. Future Backlog](#12-future-backlog)
  - [12.1 Auther Sign-In "Create Account For This App"](#121-auther-sign-in-create-account-for-this-app)
  - [12.2 Access Request Instead Of Auto-Grant](#122-access-request-instead-of-auto-grant)
  - [12.3 Private Book Request Flow](#123-private-book-request-flow)
  - [12.4 Comment Moderation Dashboard In Blog](#124-comment-moderation-dashboard-in-blog)
  - [12.5 Public Profile Page](#125-public-profile-page)
  - [12.6 Role Source Of Truth](#126-role-source-of-truth)
  - [12.7 Post Comment Grant Model](#127-post-comment-grant-model)
  - [12.8 Signup Analytics And Abuse Controls](#128-signup-analytics-and-abuse-controls)
  - [12.9 Account Linking And Duplicate Emails](#129-account-linking-and-duplicate-emails)
- [13. Definition Of Done](#13-definition-of-done)
  - [13.1 Blog Signup Entrypoint](#131-blog-signup-entrypoint)
  - [13.2 Blog UI](#132-blog-ui)
  - [13.3 Payload Role Safety](#133-payload-role-safety)
  - [13.4 Payload Comment Authorization](#134-payload-comment-authorization)
  - [13.5 Payload Mirror And Deferred Grants](#135-payload-mirror-and-deferred-grants)
  - [13.6 End-To-End Smoke](#136-end-to-end-smoke)
  - [13.7 Automated Tests](#137-automated-tests)
